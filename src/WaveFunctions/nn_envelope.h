...
public:
    ...
    NN_envelope(int N, int D, int Nin, int Nhid, const std::vector<double>& params);
    NN_envelope(int N, int D, int Nin, int Nhid, ActivationFunc actFunc, const std::vector<double>& params);
