 ...
 * will implement specific algorithms (like Metropolis).
...
public:
     ...
     * @param stepParameter The step length or time step for the proposal.
     ...
     */
    virtual double get_target_acceptanceRatio() const = 0;
